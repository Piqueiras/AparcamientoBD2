...
public class ModeloTablaReservar extends AbstractTableModel{
    ...
    public Object getValueAt(int row, int col){
        ...
        switch (col){
            ...
            case 6: resultado=reservas.get(row).getDuracion().toDays() + " d, " + reservas.get(row).getDuracion().toHoursPart() + " h, " + reservas.get(row).getDuracion().toMinutesPart()  + "min y " + reservas.get(row).getDuracion().toSecondsPart() + " s"; break;
